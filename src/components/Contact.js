            ...
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe
                        ...
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2552.395163540269!2d-119.11413858255614!3d50.228522099999985!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537dd0a03420af75%3A0x465a9d90fc989381!2s9605%20Wolfe%20Dr%2C%20Coldstream%2C%20BC%20V1B%203G7!5e0!3m2!1sen!2sca!4v1650425732036!5m2!1sen!2sca"
                    />
                    <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            ...
                            <p className="mt-1">
                                9605 Wolfe Drive <br />
                                Coldstream, BC V1B 3G7
                            </p>
                        </div>
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 className="title-font font-semibold text-white tracking-widest text-cs">
                                EMAIL
                            </h2>
                            <a href="mailto: lokmer27@hotmail.com" className="text-indigo-400 leading-relaxed">
                                lokmer27@hotmail.com
                            </a>
                            <h2 className="titlefont font-semibold text-white tracking-widest text-xs mt-4">
                                PHONE
                            </h2>
                            <p className="leading-relaxed">(250)-540-4885</p>
                        </div>
                    </div>
                </div>
                <form 
